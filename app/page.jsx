...
export default async function Page() {
  ...
  const { news: newsCat } = await getNews(
    `status=true&categories=637e85eb0fa3a7650b745132&limit=3`
  );
  const { news: newsCat1 } = await getNews(
    `status=true&categories=637e85ef0fa3a7650b74513c&limit=3`
  );
  const { news: newsVideo } = await getNews(
    `status=true&categories=637e89cf0fa3a7650b745153&limit=3`
  );
